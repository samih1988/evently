...
class AppStyles {
  ...
  static TextStyle reg12mainLightColor = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: AppColors.mainLightColor,
  );
  static TextStyle reg12mainDarkColor = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: AppColors.mainDarkColor,
  );
  static TextStyle reg12GreyColor = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.w400,
  ...
  static TextStyle semi24whiteColor = GoogleFonts.poppins(
    fontSize: 24,
    fontWeight: FontWeight.w600,
    color: AppColors.white,
  );
  ...
  static TextStyle semi16MainLight = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: FontWeight.w600,
    color: AppColors.mainLightColor,
  );
  ...
  static TextStyle reg14mainLightColor = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: AppColors.mainLightColor,
  );
  ...
  static TextStyle reg12mainColor = GoogleFonts.poppins(
    fontSize: 12,
    fontWeight: FontWeight.w400,
    color: AppColors.mainColor,
  );
  static TextStyle reg14grey = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: AppColors.grey,
  );

  static TextStyle semi14maincolor = GoogleFonts.poppins(
    fontSize: 14,
    fontWeight: FontWeight.w600,
    color: AppColors.mainColor,
  );
